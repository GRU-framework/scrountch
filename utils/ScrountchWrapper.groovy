...
//TODO addNoRepaint option to bypass scrountch.jar (used to create scrountch itself)
...
//TODO: try with scrountch
def scriptFile = new File( '../../../src/' +scriptBase + '.groovy' )
...
//do the same with SCROUNTCH_HOME (otherwise current directory
...
ant.jar( destfile: destFile, compress: true ) {
    ...
    zipgroupfileset( dir: '../../jars', includes: 'scrountch.jar' )
    //zipgroupfileset( dir: SCROUNTCH_HOME, includes: 'scrountch*.jar' )
    // addNoRepaint more jars, depending on the script dependencies
